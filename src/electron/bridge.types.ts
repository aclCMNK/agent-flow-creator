...
export const IPC_CHANNELS = {
	...
	// `git clone <url> <destPath>` in the main process.
	//
	// The renderer sends CloneRepositoryRequest; main returns CloneRepositoryResult.
	// Progress streaming is NOT implemented in this version — the call resolves
	// when git exits (success or failure). Cancellation is not yet supported.
	GIT_CLONE: "git:clone",
...
// runs `git clone <url> <destDir>/<repoName>` and returns the result.
//
// Cancellation: not supported in this version.
// Progress streaming: not supported — call resolves when git exits.
